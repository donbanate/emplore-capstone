<?php  
    ...
    $countTrain = $result1-> num_rows;

    $rep = "SELECT * FROM reports";
    $result2 = $conn->query($rep);
    $countRep = $result2-> num_rows;
                ...
                <div class="col-xl-4 col-sm-4">
                    <div class="card text-white bg-success h-100">
                        <div class="card-body bg-success">
                            ...
                            <h6><strong><a class="text-white" href="checkedTrainings.php" data-toggle="tooltip" title="GO TO CHECKED TRAININGS" data-placement="right"> CHECKED TRAININGS</a></strong></h6>
                            <h1 class="display-4"><?php echo $countTrain; ?></h1>
                        </div>
                    </div>  
                </div>
                <div class="col-xl-4 col-sm-4">
                    <div class="card text-white bg-info h-100">
                        <div class="card-body bg-info">
                            ...
                            <h6 class=""><a class="text-white" href="trainRequest.php" data-toggle="tooltip" title="GO TO TRAINING REQUESTS" data-placement="right"><strong> TRAINING REQUEST</strong></a></h6>
                            <h1 class="display-4"><?php echo $countReq; ?></h1>
                        </div>
                    </div>  
                </div>
                <div class="col-xl-4 col-sm-4">
                    <div class="card text-white bg-warning h-100">
                        <div class="card-body bg-warning">
                            ...
                            <h6><a class="text-white" href="viewReports.php" data-toggle="tooltip" title="GO TO SUBMITTED REPORTS" data-placement="right"><strong>SUBMITTED REPORTS</a></strong></h6>
                            <h1 class="display-4"><?php echo $countRep; ?></h1>
                        </div>
                    </div>  
                </div>
            </div>
